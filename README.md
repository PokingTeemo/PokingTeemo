...
### 1. OSS 대회 - Geomemo (위치 기반 감정 기록 & 인사이트 플랫폼)
- **기간**: 2025.07 ~ 2025.08
- **프로젝트 링크**: https://github.com/2025-OSS-Project
- **프로젝트 개요**
    - 위치-감정-시간 간의 패턴을 분석하고 주변 지인들과 이러한 데이터를 공유할 수 있는 SNS 서비스
- **담당한 업무**
    - **프로젝트 팀장**
    - AWS Infra 구성, **Github Actions 통한 CI/CD 파이프라인 구축**
    - **AWS SQS를 이용한 비동기 처리** 구현
    - **AWS Infra 관리** 및 **GitHub Actions를 활용한 CI/CD 파이프라인 구축**
        - 스프링 서버와 AI 서버의 빌드 및 배포 자동화를 구현
    - **EventBridge를 이용한 EC2 사용 시간 최적화**
    - Github 권한 설정 및 레포지토리 설정
        - PR 생성 필수, 브랜치 보호 규칙 설정
        - **Health Check + DB 연결 체크 통과 & Code Review** 진행 후 병합 가능 설정
          
### 2. Aimo (AI를 활용한 갈등 중재 프로젝트)
...
### 5. 동국대학교 졸업 프로젝트 - Unimon (2024.01 ~ 2024.06)
- **프로젝트 개요**  
  - 대학생을 위한 경제 비서 서비스  
